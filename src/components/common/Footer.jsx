      ...
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8 text-sm">
        ...
        <div>
          ...
          <div className="flex space-x-4 text-xl">
            <Link className="hover:mt-4 hover:bg-white hover:text-[#902923] transition-all text-gray-800 flex items-center justify-center mt-6 w-9 h-9 bg-[#902923] rounded-full">
              <FaInstagram />
            </Link>
            <Link className="hover:mt-4 hover:bg-white hover:text-[#902923] transition-all text-gray-800 flex items-center justify-center mt-6 w-9 h-9 bg-[#902923] rounded-full">
              <FaYoutube />
        ...
        <div>
          ...
          <button className="inline mt-4 mb-2 py-2 px-6 bg-[#902923] text-gray-900 hover:bg-white hover:text-[#902923] font-semibold rounded-md hover:scale-105 transition-all">SUBSCRIBE</button>
        </div>
      </div>
