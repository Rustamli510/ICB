...
const WorkWithUs = () => {
    return (
        <section className="w-full">
            ...
            <div className="flex flex-col md:flex-row justify-between min-h-screen max-w-6xl mx-auto px-8 lg:px-0">
                ...
                {/* Application Form */}
                <form className="w-full max-w-lg bg-gray-800 p-6 rounded-lg shadow-md text-white my-10 md:ml-8">
