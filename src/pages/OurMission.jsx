...
const OurMission = () => {
    return (
        <section className="w-full mb-5">
            ...
            <section className="bg-gray-800 py-10 px-4 md:px-16">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center md:justify-between space-y-6 md:space-y-0 md:space-x-10">
                    ...
                    <div className="flex flex-col items-start">
                        <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">Let us help you</h2>
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start space-x-0 md:space-x-6 space-y-4 md:space-y-0">
                        {helpCards.map((card, index) => (
                            <div
                                key={index}
                                className="bg-red-500 text-white p-6 w-full sm:w-80 md:w-64 h-52 rounded-lg shadow-lg flex flex-col justify-between hover:scale-105 transition-all"
                            >
